	...
	render() {
		return (
			<Popover
				...
				<svg className="notificationIcon" onClick={this.handleClick} width="23px" height="26px" viewBox="-4 4 23 26" version="1.1" xmlns="http://www.w3.org/2000/svg" 	xmlnsXlink="http://www.w3.org/1999/xlink">
